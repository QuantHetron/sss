...
friends_data = [{"name": "bot", "photo": "bot.jpg", "country": "Thailand", "language": "ไทย ", "greeting": "สุขสันต์วันเกิด (S̄uk̄hs̄ạnt̒ wạn keid)", "flag": "thailand_flag.jpg"},
    ...
    {"name": "bhunf", "photo": "bhunf.jpg", "country": "China", "language": "中文", "greeting": "生日快乐 (Shēngrì kuàilè)", "flag": "china_flag.jpg"},  
    ...
    {"name": "wei", "photo": "wei.jpg", "country": "Taiwan", "language": "中文", "greeting": "生日快樂 (se lit khoai lok)", "flag": "taiwan_flag.jpg"},
    ...
    {"name": "mei", "photo": "mei.jpg", "country": "Macau", "language": "中文", "greeting": "生日快樂 (saang jat faai lok)", "flag": "macau_flag.jpg"},
